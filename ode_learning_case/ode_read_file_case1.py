...
if __name__ == '__main__':
    ...
    shrink = Shrink(0.00001)
    w = list(func.parameters())

    #optimizer = optim.RMSprop(func.parameters(), lr=args.lr)
    optimizer = optim.Adam(func.parameters(), lr=args.lr, betas=(0.6, 0.999), eps=1e-08, weight_decay=0, amsgrad=False) #CASE 1 betas = 0.6
    ...
    for itr in range(1, args.niters + 1):
        ...
        #if itr<5000:
        #func.apply(shrink)
        shrink(func,0.001 if 0.00001*2*itr/1000>0.001 else 0.00001*2*itr/1000)

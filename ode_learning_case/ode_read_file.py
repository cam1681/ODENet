...
parser.add_argument('--rand_coef', type=float, default=0.005)
...
parser.add_argument('--test_freq', type=int, default=400)
...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        if itr == 1:
            _, batch_ti, batch_yi = get_batch(args.train_size,\
                    args.batch_size, args.train_size-args.batch_size-args.batch_time, true_yorig, t)
        ...
        #if itr<5000:
        #func.apply(shrink)
        shrink(func,0.002 if 0.0001*2*itr/1000>0.002 else 0.0005*2**(itr/1000))
